...
namespace ESP32S3_FREENOVE_DEV_KIT
{
    ...
    Camera::Camera()
    {
        ...
        m_cameraConfig.pin_d0 = CAM_Y2_PIN;
        m_cameraConfig.pin_d1 = CAM_Y3_PIN;
        m_cameraConfig.pin_d2 = CAM_Y4_PIN;
        m_cameraConfig.pin_d3 = CAM_Y5_PIN;
        m_cameraConfig.pin_d4 = CAM_Y6_PIN;
        m_cameraConfig.pin_d5 = CAM_Y7_PIN;
        m_cameraConfig.pin_d6 = CAM_Y8_PIN;
        m_cameraConfig.pin_d7 = CAM_Y9_PIN;
